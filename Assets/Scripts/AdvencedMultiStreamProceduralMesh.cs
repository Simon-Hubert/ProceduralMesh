...
public class AdvencedMultiStreamProceduralMesh : MonoBehaviour
{
    private void OnEnable() {
        ...
        meshData.SetIndexBufferParams(triangleIndexCount, IndexFormat.UInt32); //UInt32 et uint : Pour beaucoup plus de vertices
